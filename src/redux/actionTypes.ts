...
export const FETCH_ORDER_PAYMENT_STATUSES_SUCCESS = 'orders/FETCH_PAYMENT_STATUSES_SUCCESS';
export const FETCH_DELIVERY_TYPES_SUCCESS = 'orders/FETCH_DELIVERY_TYPES_SUCCESS';

export const AUTH_LOGIN_SUCCESS = 'auth/LOGIN_SUCCESS';
export const AUTH_LOGOUT = 'auth/LOGOUT';
export const AUTH_VALIDATE_SUCCESS = 'auth/VALIDATE_SUCCESS';

export const FETCH_PREORDERS_SUCCESS = 'preorders/FETCH_SUCCESS';
export const FETCH_PREORDER_STATUSES_SUCCESS = 'preorders/FETCH_STATUSES_SUCCESS';

export const FETCH_REVIEWS_SUCCESS = 'reviews/FETCH_SUCCESS';
